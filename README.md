...
📌 **Tech:** MERN, Judge0 API, Tailwind CSS  
...
✔️ Booking + payment + live tracking  
✔️ Damage & maintenance auditing  
✔️ Fleet admin dashboard  
✔️ Secure authentication  

📌 **Tech:** PHP, MySQL, JS, Tailwind CSS  
...
✔️ AI-powered keyword scoring  
✔️ PDF/Excel exporting  
✔️ Summary analytics & domain detection  
✔️ Chat-based interactive UI  
...
<p align="center">
  <img src="https://media2.giphy.com/media/9igGG6KxpY0eY0Sr5u/giphy.gif" width="160"/>
</p>

### 🥇 Coding Milestones  
- 🚀 Solved **300+ coding problems** across top platforms  
- ⭐ **5-Star badges** in:  
  - Java (HackerRank)  
  - C++ (HackerRank)  
- 🎯 Strong command over DSA & logic building  

### 🎓 Technical Certifications  
- 📱 Flutter Mobile App Development — LPU  
- ☁️ Cloud Computing — NPTEL IIT Kharagpur  
- 🤖 Prompt Engineering — Infosys Springboard  

---

## 🎯 Coding Profiles (Ultra Attractive Cards)

<p align="center">

<a href="https://leetcode.com/u/__tusar27/" target="_blank">
